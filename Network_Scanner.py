...
class NetworkScanner:
    def __init__(self, network_cidr, ports=None, max_threads=100):
        self.network_cidr = network_cidr
        self.ports = ports or [21, 22, 23, 25, 53, 80, 110, 143, 443, 445, 3389]
    ...
    def scan_network(self):
        try:
            ...
            print(f"[*] Scanning {network.num_addresses} hosts in {self.network_cidr}...")
...
def main():
    ...
    parser.add_argument("network", help="Network to scan in CIDR notation (e.g., 192.168.1.0/24)")
    ...
    if args.ports:
        try:
            ...
            print("[-] Invalid port list. Please provide comma-separated port numbers.")
            return
